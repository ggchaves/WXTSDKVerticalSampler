...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/APFeedBack/APFeedBack.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MIFab/MIFab.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RVCalendarWeekView/RVCalendarWeekView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SparkBroadcastExtensionKit/SparkBroadcastExtensionKit.framework"
fi
